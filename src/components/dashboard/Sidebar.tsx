...
interface SidebarProps {
  ...
  onNewChat: () => void;
  className?: string;
  onClose?: () => void; // Optional prop to close mobile drawer on selection
}

const Sidebar = ({ activeSection, setActiveSection, onNewChat, className, onClose }: SidebarProps) => {
  ...
  return (
    <div className={cn("h-full bg-sidebar flex flex-col border-r border-sidebar-border", className)}>
      {/* Logo */}
